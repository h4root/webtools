...
const MODES = {
  guest: {
    ...
    hint: 'Ник на время: после выхода он освободится, а написанное сотрётся.',
  },
  login: {
    label: 'Войти',
    hint: 'История и вложения останутся на месте.',
  },
  register: {
    label: 'Создать аккаунт',
    hint: 'Пароль от 8 символов. Ник закрепится за тобой.',
  },
  link: { label: '', hint: '' },
};
